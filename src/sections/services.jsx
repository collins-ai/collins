      ...
      <div className="flex flex-col gap-30">
        <div className="flex flex-col gap-y-15 px-4 sm:flex-row sm:flex-wrap sm:justify-between sm:gap-y-10 sm:px-10 lg:flex-nowrap lg:gap-5 lg:px-15">
          {services.map((service, index) => (
            <div key={index} className="bg-white text-black shadow-2xl rounded-xl p-4 flex flex-col gap-5 items-start group hover:bg-gradient-to-r hover:from-orange-600 hover:to-amber-500 sm:basis-[48%] lg:basis-auto">
              <div className="bg-gradient-to-r from-orange-600 to-amber-500 text-white text-2xl p-2 rounded-lg group-hover:text-black group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-white">
                {service.icon}
              </div>
