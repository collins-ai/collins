...
import { countup, description, heading } from "../constants/heroConstant"

const Hero = () => {
  return (
    <section className="bg-black text-white px-4 py-10 text-lg min-h-screen flex flex-col gap-20 sm:justify-around sm:gap-10 lg:gap-0">
      ...
      <div className="flex flex-col gap-5 sm:flex-row sm:flex-wrap sm:justify-between lg:flex-nowrap">
        {countup.map((count, index) => (
          <div key={index} className="bg-neutral-800 px-4 py-2 flex flex-col rounded-xl sm:basis-[48%] lg:basis-1/4">
            <span className="text-2xl sm:text-4xl">{count.number}</span>
